...
class UserGenarate
{
    private array $codeCountry = ['380',];

    private array $codeOperator = ['50', '67', '63', '68'];

    private array $name = ["Харитон","Артемий","Елисей","Александр","Дмитрий","Виктор","Изяслав","Ярослав","Ростислав","Фадей","Богдан","Сергей",
